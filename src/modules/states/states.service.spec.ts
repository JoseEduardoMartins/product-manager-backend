...
const findResponse = [
  new State({ id: 1, name: 'test-1', country_id: 1 }),
  new State({ id: 2, name: 'test-2', country_id: 1 }),
  new State({ id: 3, name: 'test-3', country_id: 1 }),
];
const findOneResponse = new State({ id: 1, name: 'test-1', country_id: 1 });
const createResponse = new State({ id: 1, name: 'test-1', country_id: 1 });
const saveResponse = new State({ id: 1, name: 'test-1', country_id: 1 });
